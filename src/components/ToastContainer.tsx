...
const ToastItem = memo(function ToastItem({
  ...
  return (
    <div
      ...
      className={`flex items-center gap-3 px-4 py-3 rounded-xl border backdrop-blur-md text-white text-sm shadow-xl pointer-events-auto transition-all duration-200 ${COLORS[toast.type]} ${
